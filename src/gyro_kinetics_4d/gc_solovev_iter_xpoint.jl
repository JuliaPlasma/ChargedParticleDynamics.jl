...
function initial_conditions_barely_passing()
    solovev_xpoint_iter_initial_conditions(0, [x₀..., 3.425E-1], μ₀)
end
function initial_conditions_barely_trapped()
    solovev_xpoint_iter_initial_conditions(0, [x₀..., 3.375E-1], μ₀)
end
function initial_conditions_deeply_passing()
    solovev_xpoint_iter_initial_conditions(0, [x₀..., 5.0E-1], μ₀)
end
function initial_conditions_deeply_trapped()
    solovev_xpoint_iter_initial_conditions(0, [x₀..., 1.0E-1], μ₀)
end
