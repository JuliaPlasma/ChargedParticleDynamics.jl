...
const x₀ = from_cartesian(FIELD, 0, [1.05, 0.0, 0.0])

export default_parameters

"""
The field, and the magnetic moment `μ` of the default initial condition, shared with the 4D
guiding centre module of the same equilibrium.
"""
...
initial_conditions_barely_passing() = (
    q = [x₀..., 8.117E-4], params = (field = FIELD, μ = 2.448E-6))
initial_conditions_barely_trapped() = (
    q = [x₀..., 7.610E-4], params = (field = FIELD, μ = 2.250E-6))
initial_conditions_deeply_passing() = (
    q = [x₀..., 1.623E-3], params = (field = FIELD, μ = 2.448E-6))
initial_conditions_deeply_trapped() = (
    q = [x₀..., 4.306E-4], params = (field = FIELD, μ = 2.250E-6))
initial_conditions_pauli() = (q = [x₀..., 4.3E-4], params = (field = FIELD, μ = 2.310E-6))
