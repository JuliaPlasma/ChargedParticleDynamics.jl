...
for i in 1:3, j in 1:3, k in j:3
    @eval $(Symbol(
        "d²v", INDEX_SUBSCRIPTS[i], "dq", INDEX_SUBSCRIPTS[j], "dq", INDEX_SUBSCRIPTS[k]))(
        t, q, p) = d²vᵢdqⱼdqₖ($(Val(i)), $(Val(j)), $(Val(k)), t, q, p)
end

function d²Hdq₁dq₁(t, q, p, params)
    (
...
function d²Hdq₁dp₁(t, q, p, params)
    (
...
function d²Hdp₁dp₁(t, q, p, params)
    (
...
for i in 1:3, j in 1:3
    ...
    @eval @inline d²Hdqᵢdqⱼ(::Val{$i}, ::Val{$j}, t, q, p, params) = $(Symbol(
        "d²Hdq", INDEX_SUBSCRIPTS[min(i, j)], "dq", INDEX_SUBSCRIPTS[max(i, j)]))(
        t, q, p, params)
    @eval @inline d²Hdpᵢdpⱼ(::Val{$i}, ::Val{$j}, t, q, p, params) = $(Symbol(
        "d²Hdp", INDEX_SUBSCRIPTS[min(i, j)], "dp", INDEX_SUBSCRIPTS[max(i, j)]))(
        t, q, p, params)
    @eval @inline d²Hdqᵢdpⱼ(::Val{$i}, ::Val{$j}, t, q, p, params) = $(Symbol(
        "d²Hdq", INDEX_SUBSCRIPTS[i], "dp", INDEX_SUBSCRIPTS[j]))(t, q, p, params)
end
...
@inline dbracket_gg_dqⱼ(k₁::Val, k₂::Val, j::Val, t, q, p) = contract(l -> d²gᵏdqₗdqₘ(
    k₁, j, l, t, q, p) * dgᵏdpₗ(k₂, l, t, q, p) +
                                                                           dgᵏdqₗ(
    k₁, l, t, q, p) * d²gᵏdqₗdpₘ(k₂, j, l, t, q, p) -
                                                                           d²gᵏdqₗdpₘ(
    k₁, j, l, t, q, p) * dgᵏdqₗ(k₂, l, t, q, p) -
                                                                           dgᵏdpₗ(
    k₁, l, t, q, p) * d²gᵏdqₗdqₘ(k₂, j, l, t, q, p))

@inline dbracket_gg_dpⱼ(k₁::Val, k₂::Val, j::Val, t, q, p) = contract(l -> d²gᵏdqₗdpₘ(
    k₁, l, j, t, q, p) * dgᵏdpₗ(k₂, l, t, q, p) -
                                                                           dgᵏdpₗ(
    k₁, l, t, q, p) * d²gᵏdqₗdpₘ(k₂, l, j, t, q, p))

@inline dbracket_gH_dqⱼ(k::Val, j::Val, t, q, p, params) = contract(l -> d²gᵏdqₗdqₘ(
    k, j, l, t, q, p) * dHdpᵢ(l, t, q, p, params) +
                                                                         dgᵏdqₗ(
    k, l, t, q, p) * d²Hdqᵢdpⱼ(j, l, t, q, p, params) -
                                                                         d²gᵏdqₗdpₘ(
    k, j, l, t, q, p) * dHdqᵢ(l, t, q, p, params) -
                                                                         dgᵏdpₗ(
    k, l, t, q, p) * d²Hdqᵢdqⱼ(j, l, t, q, p, params))

@inline dbracket_gH_dpⱼ(k::Val, j::Val, t, q, p, params) = contract(l -> d²gᵏdqₗdpₘ(
    k, l, j, t, q, p) * dHdpᵢ(l, t, q, p, params) +
                                                                         dgᵏdqₗ(
    k, l, t, q, p) * d²Hdpᵢdpⱼ(j, l, t, q, p, params) -
                                                                         dgᵏdpₗ(
    k, l, t, q, p) * d²Hdqᵢdpⱼ(l, j, t, q, p, params))

dλₒdqⱼ(j::Val, t, q, p, c) = dbracket_gg_dqⱼ(c[1], c[2], j, t, q, p)
dλₒdpⱼ(j::Val, t, q, p, c) = dbracket_gg_dpⱼ(c[1], c[2], j, t, q, p)

function dλ₁dqⱼ(j::Val, t, q, p, params, c)
    -dλₒdqⱼ(j, t, q, p, c) * λ₁(t, q, p, params, c) / λₒ(t, q, p, c) +
    dbracket_gH_dqⱼ(c[2], j, t, q, p, params) / λₒ(t, q, p, c)
end

function dλ₁dpⱼ(j::Val, t, q, p, params, c)
