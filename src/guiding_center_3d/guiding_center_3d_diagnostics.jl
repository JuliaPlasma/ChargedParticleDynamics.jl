...
function compute_energy(t::SolutionTimes, q::DataSeries, p::DataSeries, params)
...
"""
function compute_energy_error(t::SolutionTimes, q::DataSeries, p::DataSeries, params)
