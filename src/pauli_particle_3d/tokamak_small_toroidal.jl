...
initial_conditions_barely_passing() = initial_conditions(
    Vector(from_cartesian(FIELD, 0, [1.05, 0.0, 0.0])), 8.117E-4, 2.448E-6)
initial_conditions_barely_trapped() = initial_conditions(
    Vector(from_cartesian(FIELD, 0, [1.05, 0.0, 0.0])), 7.610E-4, 2.250E-6)
initial_conditions_deeply_passing() = initial_conditions(
    Vector(from_cartesian(FIELD, 0, [1.05, 0.0, 0.0])), 1.623E-3, 2.448E-6)
initial_conditions_deeply_trapped() = initial_conditions(
    Vector(from_cartesian(FIELD, 0, [1.05, 0.0, 0.0])), 4.306E-4, 2.250E-6)
...
initial_conditions_pauli() = initial_conditions(
    Vector(from_cartesian(FIELD, 0, [1.05, 0.0, 0.0])), 4.3E-4, 2.310E-6)
