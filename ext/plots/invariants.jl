...
function plot_invariant(t, invariant; label, size = (800, 400), labelsize = 24,
        ticklabelsize = 18, padding_left = 5, padding_right = 5)
...
function plot_error(t, e; label, size = (800, 400), labelsize = 24,
        ticklabelsize = 18, padding_left = 5, padding_right = 5)
    fg = Figure(size = size, figure_padding = (padding_left, padding_right, 5, 5))
    ax = Axis(fg[1, 1],
        xlabel = "t",
