...
function plot_trajectory_poloidal(
        R, Z; label = nothing, linewidth = trajectory_poloidal_linewidth, kwargs...)
    fg, ax = plot_poloidal_figure(; kwargs...)
    plot_trajectory_poloidal!(fg, ax, R, Z; label = label, linewidth = linewidth)
    fg, ax
end

function plot_trajectory_projection_figure(;
        xlabel = "X", ylabel = "Y", size = (500, 500), aspect = 1,
...
function plot_trajectory_projection(
        x, y; label = nothing, linewidth = trajectory_poloidal_linewidth, kwargs...)
