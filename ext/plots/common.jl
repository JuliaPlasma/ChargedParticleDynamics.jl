...
function plot_poloidal_figure(;
        size = (600, 600), limits = (nothing, nothing), labelsize = 24, ticklabelsize = 18)
...
function plot_3d_figure(; size = (800, 800), limits = (nothing, nothing, nothing),
        labelsize = 24, ticklabelsize = 18)
